        ...
        <div className="mx-auto max-w-5xl px-4 py-8 sm:px-5">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            <div className="space-y-1">
              <p className="font-[family-name:var(--font-display)] text-lg text-stone-800">Estante+</p>
              <p className="text-xs text-stone-500">
                Projeto de portfólio · React 19 · Node.js · Prisma · PostgreSQL
              </p>
              <p className="text-xs text-stone-400">Assinatura simulada — sem cobrança real</p>
            </div>
            <div className="flex flex-col gap-2 text-sm sm:items-end">
              <a
                ...
                className={`${focusRing} inline-flex items-center gap-1.5 font-semibold text-stone-700 hover:text-stone-900`}
              >
                ...
                thiagokerbeer/Estante-
              </a>
              <nav aria-label="Informações legais" className="flex flex-wrap items-center gap-x-4 gap-y-1">
                <Link
                  to="/privacidade"
                  className={`${focusRing} text-amber-900 underline-offset-2 hover:underline`}
                >
                  Privacidade e LGPD
                </Link>
              </nav>
          ...
          <p className="mt-6 border-t border-stone-200/60 pt-4 text-xs leading-relaxed text-stone-400">
            Catálogo e sinopses são{" "}
            <strong className="font-medium text-stone-500">conteúdo de demonstração</strong>. Boas práticas de
            transparência (LGPD) aplicadas em modo de estudo — veja a página de privacidade.
          </p>
        </div>
      </footer>
