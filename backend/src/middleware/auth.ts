...
/**
 * Após JWT válido: confirma que o usuário ainda existe e anexa seus dados a `req.sessionUser`.
 * Rotas downstream usam `req.sessionUser` diretamente — sem segunda query ao banco.
